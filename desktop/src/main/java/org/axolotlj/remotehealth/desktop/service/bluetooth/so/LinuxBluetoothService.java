...
/**
 * Implementación de Bluetooth para Linux usando TinyB/BlueZ.
 */
public class LinuxBluetoothService implements BluetoothService {
	...
	public List<BluetoothDeviceInfo> getDevices() {
		...
		try {
			...
			dataLogger.logException("Error al escanear dispositivos: ", e);
		}
		return devices;
	}
	...
	public void establishConnection(BluetoothDeviceInfo device, Runnable onSuccess, Runnable onFailure) {
		try {
			...
			// Lanzar lector en segundo plano
...
//		}
	...
	@Override
	public void onSignalLost(Runnable handleDisconnection) {
	    this.disconnectHandler = handleDisconnection;
	}
