package org.axolotlj.remotehealth.core.config.filt.defaults;
...
public class DefaultRealTimeEcg {
    private static final PropertiesManager props = new PropertiesManager(SharedPaths.DEFAULTS_REAL_TIME_FILTERS_PROPERTIES.substring(1));
