...
public class FrequencyDomainAnalyzer {
	...
	public static ArrayList<MutablePair<Double, Double>> computeFFT(double[] signal,
			double FS) {
		dataLogger.logInfo("Computado Transformada Rapida de Fourier (JTransforms)");
		// ==========================
		...
		dataLogger.logDebug("Tiempo total de computo para FFT: " + (endTime - startTime) + " ms");
		...
		endTime = System.currentTimeMillis();
		dataLogger.logDebug("Calcular magnitud + normalizar: " + (endTime - startTime) + " ms");
		...
		endTime = System.currentTimeMillis();
		dataLogger.logDebug("Generar objeto respuesta: " + (endTime - startTime) + " ms");
    ...
    public static ArrayList<MutablePair<Double, Double>> computeFFTv2(double[] signal, double FS) {
		dataLogger.logInfo("Computado Transformada Rapida de Fourier (Apache Commons Math)");
        ...
        // ===============================
        dataLogger.logInfo("Calculando magnitudes y eje de frecuencia");
        ...
        endTime = System.currentTimeMillis();
        dataLogger.logDebug("Tiempo total de computo para calculo de magnitudes y eje de frecuencia : " + (endTime - startTime) + " ms");
