...
public class RealTimeFilters {
	...
	public RealTimeFilters(double sampleRate) {
		...
		filterBandPassECG.bandPass(cfg.getEcgBandpassOrder(), sampleRate, cfg.getEcgBandpassLow(),
				cfg.getEcgBandpassHigh());
		filterBandstopECG.bandStop(cfg.getEcgBandstopOrder(), sampleRate, cfg.getEcgBandstopHigh(), cfg.getEcgBandstopLow());

		filterBandPassIr.bandPass(cfg.getPlethBandpassOrder(), sampleRate, cfg.getPlethBandpassLow(),
				cfg.getPlethBandpassHigh());
		filterBandstopIr.bandStop(cfg.getPlethBandstopOrder(), sampleRate, cfg.getPlethBandstopHigh(), cfg.getPlethBandstopLow());

		filterBandPassRed.bandPass(cfg.getPlethBandpassOrder(), sampleRate, cfg.getPlethBandpassLow(),
				cfg.getPlethBandpassHigh());
		filterBandstopRed.bandStop(cfg.getPlethBandstopOrder(), sampleRate, cfg.getPlethBandstopHigh(), cfg.getPlethBandstopLow());
	}
