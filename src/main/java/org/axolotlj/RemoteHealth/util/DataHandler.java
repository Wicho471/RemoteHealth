...
public class DataHandler {
	...
	public static double[] extractValues(ArrayList<StructureData> dataList, SensorField field) {
	  ...
	  public static ArrayList<MutablePair<Long, Double>> extractValidPairs(ArrayList<StructureData> dataList, SensorField field) {
    ...
    private static SensorValue<Short> parseSensorShort(String value) {
        try {
            if ("NR".equalsIgnoreCase(value)) return SensorValue.notReady();
            if ("ERR".equalsIgnoreCase(value)) return SensorValue.error();
